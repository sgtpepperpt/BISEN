...
void SseCrypt::hmac(unsigned char* key, unsigned char* data, int dataSize, unsigned char* md) {
    unsigned int mdSize;
...
vector<unsigned char> SseCrypt::encCounter(unsigned char* key, unsigned char* data, int dataSize) {
...
void SseCrypt::deriveKey (void* append, int appendSize, void* data, int dataSize, unsigned char* md) {
...
vector<unsigned char> SseCrypt::encData (unsigned char* key, unsigned char* data, int size) {
    EVP_CIPHER_CTX *ctx;
    int len;
    int ciphertext_len;
